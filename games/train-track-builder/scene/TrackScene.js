...
import StationModels from './StationModels';

function SceneContent({
  grid, cols, rows, phase, skin,
  selectedPieceId, validPathResult,
  stationA, stationB,
  onCellClick, onTrainArrived,
}) {
...
export default function TrackScene(props) {
